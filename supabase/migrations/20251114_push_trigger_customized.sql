-- Migration: Trigger de push notifications com ícones personalizados
-- Created: 2025-11-14
-- Atualiza para usar ícones corretos no Android
...
-- Não precisa recriar o trigger, apenas atualizar a função
COMMENT ON FUNCTION notify_new_message() IS 'Envia push notification quando uma nova mensagem é criada (v4 - ícones personalizados)';
