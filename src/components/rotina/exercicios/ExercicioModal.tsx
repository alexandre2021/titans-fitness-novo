 ...
 * 
 * Optamos por reutilizar o componente ExercicioDetalhesModal que já estava
 * implementado e funcionando no processo de execução das rotinas, garantindo
 * consistência na interface e evitando duplicação de código. Este componente
 * já possui toda a lógica necessária para exibir informações técnicas,
 * músculos primários/secundários, instruções formatadas e mídias dos exercícios.
 */
...
const CORES_GRUPOS_MUSCULARES: {[key: string]: string} = {
  ...
  'Glúteos': 'bg-green-100 text-green-800 border-green-200',
  'Panturrilha': 'bg-green-100 text-green-800 border-green-200',
  'Trapézio': 'bg-blue-100 text-blue-800 border-blue-200'
};
...
export const ExercicioModal: React.FC = () => {
  ...
  // ✅ NOVA: Função para mostrar detalhes do exercício
  ...
  return (
    <>
      ...
      {/* ✅ NOVA: Modal de detalhes do exercício */}
