...
const MessagesButton = ({ onClick, unreadCount, position = 'top-right' }: MessagesButtonProps) => {
  ...
  return (
    <Button
      variant="secondary"
      className={`fixed z-50 rounded-full shadow-lg flex items-center justify-center p-0 ${sizeClasses} ${positionClasses} bg-green-600 hover:bg-green-700 text-white`}
      onClick={onClick}
    >
      <MessageSquare />
