...
const GRUPO_CORES: { [key: string]: string } = {
  ...
  'Antebraço': 'bg-teal-100 text-teal-800', 'Abdômen': 'bg-orange-100 text-orange-800',
  'Glúteos': 'bg-violet-100 text-violet-800', 'Panturrilha': 'bg-indigo-100 text-indigo-800'
};
